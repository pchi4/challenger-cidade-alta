...
export const ModalComponent = ({
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => setProgress(progress - 10), 1000);
    return () => {
      clearInterval(interval);
    };
  }, [openModal, progress, setIsFinish, setProgress]);
  ...
  useEffect(() => {
    function handleKeyDown(e: any) {
      ...
      alphas.forEach((value, idx, c) => {
        console.log(!c.includes(e.key));

        if (e.key === c[0].toLocaleLowerCase()) {
          setIsSuccess((event) => ({
            ...event,
            first: true,
          }));
        ...
        if (e.key === c[1].toLocaleLowerCase()) {
          setIsSuccess((event) => ({
            ...event,
            second: true,
          }));
          ...
          {!isFinish && (
            <>
              ...
              <form className="max-w-sm mx-auto">
                ...
                >
                  Por favor, Digite os characters de forma sequencial!
                </p>
              </form>
